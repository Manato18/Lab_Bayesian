...
変更点を以下のチェックリストに従いチェックしていく。
内容が分からない場合は[GitHubを使ったソフト開発ガイド](https://www.notion.so/GitHub-6f88405a94be4137a1ddaf3c5b5d0046)を参照すること。
...
- [ ] READMEも必要あれば更新すること
- [ ] 下記テストのルールに則ってテストをしているか？

### テストのルール

PRを出す際は基本的にテストを行う必要がある。READMEの更新など、コードに影響がないPRの場合は例外としてテストを実行する必要はない。

<!-- もしNG項目、懸念点、備考あればここに説明を記載 -->

### Python

- [ ] Docstrings形式（Googleスタイル）でコメントを記載すること
<!-- もしNG項目、懸念点、備考あればここに説明を記載 -->
